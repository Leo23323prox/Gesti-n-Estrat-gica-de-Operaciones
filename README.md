...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .result-box table { color: #003d47; }
        .result-box th { background: #00acc1 !important; color: #ffffff !important; }
        .result-box td { border-bottom: 1px solid #80deea !important; color: #003d47; }
        .result-box strong { color: #006064; }
        .result-box p { color: #003d47; }
        .result-box label { color: #006064; }
        .ia-insight {
            background: linear-gradient(135deg, #e0f7fa, #b2ebf2);
        ...
        .ia-insight.warning { border-left-color: #f9a825; background: linear-gradient(135deg,#fffde7,#fff9c4); color: #4a3600; }
        .ia-insight.success { border-left-color: #2e7d32; background: linear-gradient(135deg,#e8f5e9,#c8e6c9); color: #1b3a1e; }
        .ia-insight.danger  { border-left-color: #c62828; background: linear-gradient(135deg,#ffebee,#ffcdd2); color: #4a0000; }
        ...
        charts.pap = new Chart(ctxPAP, {
            ...
            data: {
                ...
                datasets: [
                    ...
                    {
                        label: 'Costo P1 (S/.)',
                        data: costoLin1.map((c,i)=>c+costoContrat1[i]+costoDespid1[i]),
                    ...
                    {
                        label: 'Costo P2 (S/.)',
                        data: costoLin2.map((c,i)=>c+costoInvSob2[i]+costoInvFalt2[i]),
